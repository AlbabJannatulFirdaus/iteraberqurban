...
<head>
    ...
    <title>Dashboard - TABUNGAN QURBAN</title>
    <!-- Favicons -->
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-kurban2">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="<?php echo site_url('user/dashboard') ?>">ITERA BERQURBAN</a>
        <!-- Sidebar Toggle-->
        <a>
        ...
        <ul class="navbar-nav ms-auto me-3 me-lg-4">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo session()->get('akun_username_user') ?> <i class="fas fa-user fa-fw"></i></a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="<?php echo site_url('user/dashboard/tabungan') ?>">
                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                            Data Tabungan Qurban
                        </a>
                        <a class="nav-link" href="<?php echo site_url('user/dashboard/menabung') ?>">
                ...
                <div class="sb-sidenav-footer">
                    ...
                    <?php echo session()->get('akun_nama_user') ?>
                </div>
            </nav>
        </div>