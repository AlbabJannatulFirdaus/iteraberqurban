                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputPasswordKonfirmasi" type="password" name="konfirmasi_password_user" placeholder="Konfirmasi Password" />
                                            <label for="inputPassword">Konfirmasi Password</label>
                                        </div>

                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="small" href="<?php echo site_url("user/login") ?>">Return to Login</a>
